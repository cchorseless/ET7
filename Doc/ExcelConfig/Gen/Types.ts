...
export class ItemConfigRecord {
    ...
    constructor(_json_: any) {
        ...
        if (_json_.DecomposeStarStone === undefined) { throw new Error() }
...
export class BattlePassChargeConfigRecord {
    ...
    constructor(_json_: any) {
        if (_json_.id === undefined) { throw new Error() }
        this.id = _json_.id
        if (_json_.SeasonId === undefined) { throw new Error() }
        this.SeasonId = _json_.SeasonId
        if (_json_.IsCourier === undefined) { throw new Error() }
        this.IsCourier = _json_.IsCourier
        if (_json_.ChargeTo === undefined) { throw new Error() }
        this.ChargeTo = new Item.ItemInfoBean(_json_.ChargeTo)
        if (_json_.ChargeBy === undefined) { throw new Error() }
...
export class BattlePassTaskConfigRecord {
    ...
    constructor(_json_: any) {
        ...
        if (_json_.BindHero === undefined) { throw new Error() }
...
export class BattlePassLevelUpConfigRecord {
    ...
    constructor(_json_: any) {
        if (_json_.id === undefined) { throw new Error() }
        this.id = _json_.id
        if (_json_.BattlePassLevel === undefined) { throw new Error() }
        this.BattlePassLevel = _json_.BattlePassLevel
        if (_json_.SeasonId === undefined) { throw new Error() }
        this.SeasonId = _json_.SeasonId
        if (_json_.LevelUpExp === undefined) { throw new Error() }
        this.LevelUpExp = _json_.LevelUpExp
        if (_json_.TaskComPrize === undefined) { throw new Error() }
        this.TaskComPrize = new Item.ItemInfoBean(_json_.TaskComPrize)
        if (_json_.TaskSpePrize === undefined) { throw new Error() }
...
export class WearableConfigRecord {
    ...
    constructor(_json_: any) {
        ...
        if (_json_.image_inventory === undefined) { throw new Error() }
        this.imageInventory = _json_.image_inventory
        if (_json_.item_description === undefined) { throw new Error() }
        ...
        if (_json_.item_rarity === undefined) { throw new Error() }
        this.itemRarity = _json_.item_rarity
        if (_json_.used_by_heroes === undefined) { throw new Error() }
        this.usedByHeroes = _json_.used_by_heroes
        if (_json_.bundle === undefined) { throw new Error() }
...
export class BuffEffectConfigRecord {
    ...
    constructor(_json_: any) {
        if (_json_.effectid === undefined) { throw new Error() }
        this.effectid = _json_.effectid
        if (_json_.target === undefined) { throw new Error() }
        this.target = _json_.target
        if (_json_.propinfo === undefined) { throw new Error() }
        this.propinfo = new Map<string, number>(); for(var _entry_ of _json_.propinfo) { let _k:string; _k = _entry_[0];  let _v:number;  _v = _entry_[1]; this.propinfo.set(_k, _v);  }
    }
...
export class CourierAbilityLevelUpConfigRecord {
    ...
    constructor(_json_: any) {
        ...
        if (_json_.PopulationRoof === undefined) { throw new Error() }
        this.PopulationRoof = _json_.PopulationRoof
        if (_json_.PopuGoldCost === undefined) { throw new Error() }
        ...
        if (_json_.AutoGoldGetGold === undefined) { throw new Error() }
        this.AutoGoldGetGold = _json_.AutoGoldGetGold
        if (_json_.AutoGoldGetWood === undefined) { throw new Error() }
...
export class CombinationConfigRecord {
    ...
    constructor(_json_: any) {
        ...
        if (_json_.acitve_special_effect === undefined) { throw new Error() }
...
export class PoolGroupConfigRecord {
    ...
    constructor(_json_: any) {
        if (_json_.poolgroupid === undefined) { throw new Error() }
        this.poolgroupid = _json_.poolgroupid
        if (_json_.PoolGroup === undefined) { throw new Error() }
...
export class PoolGroupBean {
    ...
    constructor(_json_: any) {
        if (_json_.PoolConfigId === undefined) { throw new Error() }
        this.PoolConfigId = _json_.PoolConfigId
        if (_json_.PoolWeight === undefined) { throw new Error() }
...
export class PublicShopSellItemBean {
    ...
    constructor(_json_: any) {
        if (_json_.ItemSlot === undefined) { throw new Error() }
        this.ItemSlot = _json_.ItemSlot
        if (_json_.ItemName === undefined) { throw new Error() }
        this.ItemName = _json_.ItemName
        if (_json_.ItemLimit === undefined) { throw new Error() }
        this.ItemLimit = _json_.ItemLimit
        if (_json_.RoundLock === undefined) { throw new Error() }
        this.RoundLock = _json_.RoundLock
        if (_json_.MinDifficulty === undefined) { throw new Error() }
...
export class RoundBoardConfigRecord {
    ...
    constructor(_json_: any) {
        if (_json_.id === undefined) { throw new Error() }
        this.id = _json_.id
        if (_json_.round_index === undefined) { throw new Error() }
        this.roundIndex = _json_.round_index
        if (_json_.round_nextid === undefined) { throw new Error() }
        this.roundNextid = _json_.round_nextid
        if (_json_.round_type === undefined) { throw new Error() }
        ...
        if (_json_.roundprize_wood === undefined) { throw new Error() }
        this.roundprizeWood = _json_.roundprize_wood
        if (_json_.round_readytime === undefined) { throw new Error() }
        this.roundReadytime = _json_.round_readytime
        if (_json_.round_time === undefined) { throw new Error() }
...
export class RoundEnemyConfigBean {
    ...
    constructor(_json_: any) {
        ...
        if (_json_.unit_weight === undefined) { throw new Error() }
        this.unitWeight = _json_.unit_weight
        if (_json_.position_x === undefined) { throw new Error() }
        this.positionX = _json_.position_x
        if (_json_.position_y === undefined) { throw new Error() }
        this.positionY = _json_.position_y
        if (_json_.angles_x === undefined) { throw new Error() }
        this.anglesX = _json_.angles_x
        if (_json_.angles_y === undefined) { throw new Error() }
        this.anglesY = _json_.angles_y
        if (_json_.angles_z === undefined) { throw new Error() }
        this.anglesZ = _json_.angles_z
        if (_json_.enemycreatetype === undefined) { throw new Error() }
...
export class RoundEnemyPoolConfigRecord {
    ...
    constructor(_json_: any) {
        if (_json_.id === undefined) { throw new Error() }
        this.id = _json_.id
        if (_json_.playername === undefined) { throw new Error() }
        this.playername = _json_.playername
        if (_json_.accountid === undefined) { throw new Error() }
        this.accountid = _json_.accountid
        if (_json_.population === undefined) { throw new Error() }
        this.population = _json_.population
        if (_json_.round_min === undefined) { throw new Error() }
        this.roundMin = _json_.round_min
        if (_json_.round_max === undefined) { throw new Error() }
        this.roundMax = _json_.round_max
        if (_json_.battlescore === undefined) { throw new Error() }
        this.battlescore = _json_.battlescore
        if (_json_.sectinfo === undefined) { throw new Error() }
...
export class RoundDrawEnemyConfigBean {
    ...
    constructor(_json_: any) {
        ...
        if (_json_.position_y === undefined) { throw new Error() }
        this.positionY = _json_.position_y
        if (_json_.itemslot1 === undefined) { throw new Error() }
        this.itemslot1 = _json_.itemslot1
        if (_json_.itemslot2 === undefined) { throw new Error() }
        this.itemslot2 = _json_.itemslot2
        if (_json_.itemslot3 === undefined) { throw new Error() }
        this.itemslot3 = _json_.itemslot3
        if (_json_.itemslot4 === undefined) { throw new Error() }
        this.itemslot4 = _json_.itemslot4
        if (_json_.itemslot5 === undefined) { throw new Error() }
        this.itemslot5 = _json_.itemslot5
        if (_json_.itemslot6 === undefined) { throw new Error() }
        this.itemslot6 = _json_.itemslot6
        if (_json_.WearBundleId === undefined) { throw new Error() }
...
export class RankBattleScoreExpConfigRecord {
    ...
    constructor(_json_: any) {
        if (_json_.id === undefined) { throw new Error() }
        this.id = _json_.id
        if (_json_.ScoreMin === undefined) { throw new Error() }
        this.ScoreMin = _json_.ScoreMin
        if (_json_.ScoreMax === undefined) { throw new Error() }
