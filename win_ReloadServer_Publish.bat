...
copy .\Bin\win-x64\publish\Hotfix.deps.json %OUTPUT_ROOT%\Bin\
copy .\Bin\win-x64\publish\Hotfix.dll %OUTPUT_ROOT%\Bin\
copy .\Bin\win-x64\publish\Hotfix.pdb %OUTPUT_ROOT%\Bin\
