...
namespace ET
{
    public class WService : AService
    {
            ...
            try
            {
                ...
                while (true)
                {
                    try
                    {
                        ...
                        // 改过
                        string remoteEndPoint = httpListenerContext.Request.RemoteEndPoint.ToString();
                        ...
                        // 改过
                        channel.RemoteAddress = IPEndPoint.Parse(remoteEndPoint);
                        this.channels[channel.Id] = channel;
        ...
        //改过
        protected void Get(long id, IPEndPoint address)
        {
            Get(id, $"ws://{address}");
        }
