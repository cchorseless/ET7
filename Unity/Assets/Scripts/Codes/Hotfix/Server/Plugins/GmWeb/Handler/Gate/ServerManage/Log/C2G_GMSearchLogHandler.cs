...

{
    ...
    public class C2G_GMSearchLogHandler : AMRpcHandler<C2G_GMSearchLog, G2C_GMSearchLog>
    {
        protected override async ETTask Run(Session session, C2G_GMSearchLog request, G2C_GMSearchLog response)
        {
