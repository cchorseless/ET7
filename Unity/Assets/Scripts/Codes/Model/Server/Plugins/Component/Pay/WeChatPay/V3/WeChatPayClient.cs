...
using ET.Pay.WeChatPay.V3.Extensions;
...
namespace ET.Pay.WeChatPay.V3
{
    ...
    public class WeChatPayClient : IWeChatPayClient
    {
        ...
        public WeChatPayPlatformCertificateManager _platformCertificateManager { get; private set; }
        ...
        public WeChatPayClient()
        {
            ...
            _platformCertificateManager = new WeChatPayPlatformCertificateManager();
        }
        ...
        public async ETTask<WeChatPayDictionary> ExecuteAsync(IWeChatPaySdkRequest request, WeChatPayOptions options)
        {
            if (options == null)
            {
        ...
        public async ETTask<T> ExecuteAsync<T>(IWeChatPayGetRequest<T> request, WeChatPayOptions options) where T : WeChatPayResponse
        {
            if (options == null)
            {
                throw new ArgumentNullException(nameof(options));
        ...
        public async ETTask<T> ExecuteAsync<T>(IWeChatPayPostRequest<T> request, WeChatPayOptions options) where T : WeChatPayResponse
        {
            if (options == null)
            {
                throw new ArgumentNullException(nameof(options));
        ...
        public async ETTask<T> ExecuteAsync<T>(IWeChatPayPrivacyPostRequest<T> request, WeChatPayOptions options) where T : WeChatPayResponse
        {
            if (options == null)
            {
                throw new ArgumentNullException(nameof(options));
        ...
        private async ETTask CheckResponseSignAsync(WeChatPayHeaders headers, string body, WeChatPayOptions options)
        {
