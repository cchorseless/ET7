...
namespace ET
{
    public class TCharacter : Entity, IAwake<long>, IDestroy, ITransfer
    {
        ...
        public long PartialOnlineTime { get; set; }
        ...
        [BsonIgnore]
        public SeedRandomComponent SeedRandomComp { get => GetComponent<SeedRandomComponent>(); }

        [BsonIgnore]
        public BagComponent BagComp { get => GetComponent<BagComponent>(); }

        [BsonIgnore]
        public CharacterDataComponent DataComp { get => GetComponent<CharacterDataComponent>(); }

        [BsonIgnore]
        public CharacterSteamComponent SteamComp { get => GetComponent<CharacterSteamComponent>(); }
        ...
        [BsonIgnore]
        public CharacterActivityComponent ActivityComp { get => GetComponent<CharacterActivityComponent>(); }

        [BsonIgnore]
        public HeroManageComponent HeroManageComp { get => GetComponent<HeroManageComponent>(); }

        [BsonIgnore]
        public CharacterDrawTreasureComponent DrawTreasureComp { get => GetComponent<CharacterDrawTreasureComponent>(); }

        [BsonIgnore]
        public CharacterRechargeComponent RechargeComp { get => GetComponent<CharacterRechargeComponent>(); }
        ...
        [BsonIgnore]
        public CharacterAchievementComponent AchievementComp { get => GetComponent<CharacterAchievementComponent>(); }
