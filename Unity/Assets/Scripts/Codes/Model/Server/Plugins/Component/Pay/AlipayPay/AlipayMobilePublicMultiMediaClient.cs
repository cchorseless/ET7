...
namespace ET.Pay.Alipay
{
    public class AlipayMobilePublicMultiMediaClient : IAlipayMobilePublicMultiMediaClient
    {
        ...
        public ETTask<T> ExecuteAsync<T>(IAlipayRequest<T> request, AlipayOptions options) where T : AlipayResponse
        {
            return ExecuteAsync(request, options, null);
        }

        public ETTask<T> ExecuteAsync<T>(IAlipayRequest<T> request, AlipayOptions options, string accessToken) where T : AlipayResponse
        {
