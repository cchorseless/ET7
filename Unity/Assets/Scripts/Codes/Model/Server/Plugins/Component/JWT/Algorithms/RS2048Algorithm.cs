...
namespace ET.JWT.Algorithms
{
    ...
    {
        /// <summary>
        /// Creates an instance of <see cref="RS2048Algorithm" /> using the provided pair of public and private keys.
        /// </summary>
        ...
        /// <summary>
        /// Creates an instance of <see cref="RS2048Algorithm" /> using the provided public key only.
        /// </summary>
        /// <remarks>
        ...
        /// <inheritdoc />
        public override string Name => nameof(JwtAlgorithmName.RS2048);
