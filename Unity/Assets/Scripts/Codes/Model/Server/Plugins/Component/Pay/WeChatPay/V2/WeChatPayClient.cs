using System;
using ET.Pay.WeChatPay.V2.Extensions;
...
namespace ET.Pay.WeChatPay.V2
{
    public class WeChatPayClient : IWeChatPayClient
    {
        ...
        public WeChatPayClient()
        {
            ...
            _clientCertificateManager = new WeChatPayClientCertificateManager();
        }
        #endregion

        #region IWeChatPayClient Members

        public async ETTask<T> ExecuteAsync<T>(IWeChatPayRequest<T> request, WeChatPayOptions options) where T : WeChatPayResponse
        {
            if (options == null)
            {
        ...
        public async ETTask<T> PageExecuteAsync<T>(IWeChatPayRequest<T> request, WeChatPayOptions options) where T : WeChatPayResponse
        {
            if (options == null)
            {
                throw new ArgumentNullException(nameof(options));
        ...
        public async ETTask<T> ExecuteAsync<T>(IWeChatPayCertRequest<T> request, WeChatPayOptions options) where T : WeChatPayResponse
        {
            if (options == null)
            {
                throw new ArgumentNullException(nameof(options));
