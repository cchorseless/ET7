...
namespace ET.Pay.Alipay.Extensions
{
    public static class HttpClientExtensions
    {
        ...
        public static async ETTask<string> PostAsync(this HttpClient client, string url, IDictionary<string, string> textParams)
        {
        ...
        /// <returns>响应内容</returns>
        public static async ETTask<string> PostAsync(this HttpClient client, string url, IDictionary<string, string> textParams, IDictionary<string, FileItem> fileParams)
        {
            // 如果没有文件参数，则走普通POST请求
