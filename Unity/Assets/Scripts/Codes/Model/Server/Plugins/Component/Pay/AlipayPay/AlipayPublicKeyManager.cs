...
namespace ET.Pay.Alipay
{
    ...
    {
        private readonly ConcurrentDictionary<string, string> _publicKeys = new ConcurrentDictionary<string, string>();
        ...
        public async ETTask<string> GetAlipayPublicKeyAsync(IAlipayClient client, AlipayOptions options, string certSN)
        {
            // 为空时添加本地支付宝公钥证书密钥
