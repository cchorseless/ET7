...
namespace ET
{
    ...
    public static class InnerProto2CS
    {
        ...
        private const string serverHotfixMessagePath = "../DotNet/Hotfix/Config/Message/";
        ...
        public static void Proto2CS()
        {
            ...
            if (Directory.Exists(serverHotfixMessagePath))
            {
                Directory.Delete(serverHotfixMessagePath, true);
            }
        ...
        public static void ProtoFile2CS(string fileName, string protoName, string cs, int startOpcode)
        {
            ...
            if (cs.Contains("H"))
            {
                //GenerateCS(sb, clientMessagePath, proto);
                //GenerateCS(sb, serverMessagePath, proto);
                GenerateCS(sb, serverHotfixMessagePath, proto);
            }
            if (cs.Contains("S"))
            {
                GenerateCS(sb, serverMessagePath, proto);
