...
{
public sealed partial class TActivityTotalSpendMetaStoneRecord :  Bright.Config.BeanBase 
{
    public TActivityTotalSpendMetaStoneRecord(ByteBuf _buf) 
    {
        Id = _buf.ReadInt();
    ...
    public static TActivityTotalSpendMetaStoneRecord DeserializeTActivityTotalSpendMetaStoneRecord(ByteBuf _buf)
    {
        return new Activity.TActivityTotalSpendMetaStoneRecord(_buf);
    }
    ...
    public const int __ID__ = -347984173;
