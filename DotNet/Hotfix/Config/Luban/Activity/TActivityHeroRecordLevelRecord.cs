...
{
public sealed partial class TActivityHeroRecordLevelRecord :  Bright.Config.BeanBase 
{
    public TActivityHeroRecordLevelRecord(ByteBuf _buf) 
    {
        Id = _buf.ReadInt();
    ...
    public static TActivityHeroRecordLevelRecord DeserializeTActivityHeroRecordLevelRecord(ByteBuf _buf)
    {
        return new Activity.TActivityHeroRecordLevelRecord(_buf);
    }
    ...
    public const int __ID__ = 947772902;
