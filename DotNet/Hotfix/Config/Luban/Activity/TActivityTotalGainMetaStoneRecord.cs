...
{
public sealed partial class TActivityTotalGainMetaStoneRecord :  Bright.Config.BeanBase 
{
    public TActivityTotalGainMetaStoneRecord(ByteBuf _buf) 
    {
        Id = _buf.ReadInt();
    ...
    public static TActivityTotalGainMetaStoneRecord DeserializeTActivityTotalGainMetaStoneRecord(ByteBuf _buf)
    {
        return new Activity.TActivityTotalGainMetaStoneRecord(_buf);
    }
    ...
    public const int __ID__ = -1282592238;
